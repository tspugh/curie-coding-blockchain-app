...
### 2.9 (2026-05-30) Real-mode adjudication blocked by live agent ABI drift (Decision 9)
...
- **R42 (MUST — blocker) Real-mode adjudication MUST produce at least one
  ...
  selector + agent pair.
- **R43 (MUST) When `ResponseStatus.Failed` lands, R4 attribution MUST
