...
- **UI / agent-plumbing candidate: CopilotKit / CoAgents** (`@copilotkit/react-core`, `@copilotkit/react-ui`, `@copilotkit/runtime`; MIT) — CoAgents maps to LangGraph + chat + HITL + **browser-side frontend actions** (= browser signing, R52); `CopilotRuntime` self-hosts on the Lambda Function URL; the model stays Bedrock-in-the-CoAgent (no first-class Bedrock service adapter required). Pending OQ-7 + a spike. Research: [`../research/copilotkit-fit-for-spec-0009.md`](../research/copilotkit-fit-for-spec-0009.md).
...
7. **OQ-7 (use CopilotKit / CoAgents?) — priority: medium.** Adopt CopilotKit's **CoAgents** for the co-pilot chat + agent↔UI plumbing (it maps to LangGraph + HITL + browser-side frontend actions = browser signing — R52), or hand-roll the pane + narration stream (R17/R28/R29a)? **Lean: adopt**, pending a spike of `CopilotRuntime` behind a Lambda Function URL (streaming) + Bedrock-in-the-CoAgent. Research + recommendation: [`../research/copilotkit-overview.md`](../research/copilotkit-overview.md) and [`../research/copilotkit-fit-for-spec-0009.md`](../research/copilotkit-fit-for-spec-0009.md).
